...
public class PWMDrivetrain extends SubsystemBase {
  ...
  public PWMDrivetrain() {
    ...
    PWMSparkMax leftFront = new PWMSparkMax(kLeftFrontID); 
    @SuppressWarnings("resource")
    PWMSparkMax leftRear = new PWMSparkMax(kLeftRearID);
    @SuppressWarnings("resource")
    PWMSparkMax rightFront = new PWMSparkMax(kRightFrontID);
    @SuppressWarnings("resource")
    PWMSparkMax rightRear = new PWMSparkMax(kRightRearID);
